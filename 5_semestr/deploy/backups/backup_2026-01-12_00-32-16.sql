...
\restrict YxZWzlBlaad12bW6cEuBFHUXGeQsTkT5CpTzhi0kNeDaN4FFCFUQylpHcbUCpOn
...
1	1	admin	secret	t	2026-01-12 00:31:55.690414+00
2	2	manager	secret	t	2026-01-12 00:31:55.690414+00
\.
...
--
-- Name: loan_contracts trg_audit_contracts; Type: TRIGGER; Schema: public; Owner: user
--

CREATE TRIGGER trg_audit_contracts AFTER INSERT OR DELETE OR UPDATE ON public.loan_contracts FOR EACH ROW EXECUTE FUNCTION public.fn_audit_log();
...
\unrestrict YxZWzlBlaad12bW6cEuBFHUXGeQsTkT5CpTzhi0kNeDaN4FFCFUQylpHcbUCpOn
